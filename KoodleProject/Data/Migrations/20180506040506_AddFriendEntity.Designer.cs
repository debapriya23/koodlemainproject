...
namespace Data.Migrations
{
    ...
    [Migration("20180506040506_AddFriendEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Members.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Domain.Members.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Friends.Friend", b =>
                {
                    b.HasOne("Core.Domain.Members.User", "RequestedBy")
                        .WithMany("SentFriendRequests")
                        .HasForeignKey("RequestedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Core.Domain.Members.User", "RequestedTo")
